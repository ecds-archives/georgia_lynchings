...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column('lynchings_lynching', 'd_county', self.gf('django.db.models.fields.related.ForeignKey')(related_name='d_county', null=True, to=orm['demographics.County'], blank=True), keep_default=False)
