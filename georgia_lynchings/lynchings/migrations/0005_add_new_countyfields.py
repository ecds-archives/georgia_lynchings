...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('lynchings_lynching', 'county', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['demographics.County'], null=True, blank=True), keep_default=False)
