...
class Article(models.Model):
    ...
    help = {
        ...
        'subject': '',
        'description':  'Additional Notes about where to obtain the article for the End User',
        ...
        'source': 'Internal note about the archive the article was obtained from if known.',
