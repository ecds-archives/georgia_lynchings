...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Relationship.story'
        db.add_column('reldata_relationship', 'story', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lynchings.Story'], null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Relationship.story'
        db.delete_column('reldata_relationship', 'story_id')
